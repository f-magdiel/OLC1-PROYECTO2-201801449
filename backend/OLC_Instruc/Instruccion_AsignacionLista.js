...
class asignacionLista extends Instruccion_1.Instruccion {
    //el metodo constructor
    constructor(identificador, posicion, expresion, fila, columna) {
    ...
    interpretar(arbol, tabla) {
        ...
        if (ide != null) {
            ...
            if (pos instanceof Errores_1.default)
                return pos;
            if (this.posicion.tipoDato.getTipo() != Simbolo_Tipo_1.tipoDato.ENTERO)
    ...
    getNodo() {
        let nodo = new Nodo_AST_1.default('ASIGNACION-LISTA');
